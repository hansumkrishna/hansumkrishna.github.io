...
$(document).ready(function() {
	...
	$('#subscription-form').ajaxChimp({
		...
		url: 'http://themegret.us9.list-manage1.com/subscribe/post?u=05c9c728caa33814788546457&id=79a59df02a' /* Replace it with your custom URL inside '' */
	});
...
$(document).ready(function() {
	...
	$('form.contact-form').on('submit', function(e) {
		$.post('contact/contact.html', $(this).serialize(), function(response) {
